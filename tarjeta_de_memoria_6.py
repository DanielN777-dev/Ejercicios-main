...
questions_list = [] 
questions_list.append(Question('Cuál es el planeta más grande del Sistema Solar?', 'Júpiter', 'Marte', 'Venus', 'Saturno'))
questions_list.append(Question('Cuál es el río más largo del mundo?', 'Nilo', 'Amazonas', 'Yangtsé', 'Misisipi'))
questions_list.append(Question('Cuál es el océano más grande del mundo?', 'Pacífico', 'Atlántico', 'Índico', 'Ártico'))     
questions_list.append(Question('Cuál es el país más grande del mundo?', 'Rusia', 'Canadá', 'China', 'Estados Unidos'))
